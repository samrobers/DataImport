...
if (process.platform === "win32") {
  // Windows
  oracledb.initOracleClient({ libDir: "E:\\oracle\\dbhomeXE\\instantclient" });
...
async function run() {
  ...
  try {
    ...
    if (connection.oracleServerVersion < 2100000000) {
      throw new Error(
        "This example requires Oracle Database 21.1 or later. Try selectjsonblob.js."
      );
    }
    ...
    if (oracledb.oracleClientVersion >= 2100000000) {
      await connection.execute(inssql, {
